...
mount -t cifs //10.1.0.43/Backup_Fortes_RH -o 'username=zabbix','password=z4bb1x!@2022',dir_mode=0444,file_mode=0444,nounix  /mnt/bkp_fortes_rh
mount -t cifs //10.1.0.43/Backup_Systemah -o 'username=zabbix','password=z4bb1x!@2022',dir_mode=0444,file_mode=0444,nounix  /mnt/bkp_systemah2005
