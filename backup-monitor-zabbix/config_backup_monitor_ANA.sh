...
wget -O /etc/zabbix/script-python/mount_storage.sh https://github.com/mgran2003/GITHUB-SAOCAMILO-GRTIC/raw/main/backup-monitor-zabbix/unidades/ANA-mount_storage.sh

echo '##### Download do arquivos zabbix_agentd.d userparameter #####'

wget -O /etc/zabbix/zabbix_agentd.d/userparameter_info_last_file_bkp.conf https://github.com/mgran2003/GITHUB-SAOCAMILO-GRTIC/raw/main/backup-monitor-zabbix/unidades/ANA-userparameter_info_last_file_bkp.conf
